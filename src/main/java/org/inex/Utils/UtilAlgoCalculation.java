...
public class UtilAlgoCalculation {
	...
	public static Double weightNTN(Double tf, Double df, ArrayList<Doc> docList) {
		Double weight = 0.0;
		if (df != 0) {
	...
	public static Double weightLTN(Double tf, Double df, ArrayList<Doc> docList) {
		Double weight = 0.0;
		if (tf != 0.0 && df != 0.0) {
	...
	public static Double weightBTN(Double df, ArrayList<Doc> docList) {
		Double weight = 0.0;
		if (df != 0.0) {
